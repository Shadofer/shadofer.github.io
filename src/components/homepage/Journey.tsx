...
export default function Journey() {
  const [journeyShown, setJourneyShown] = useState(false);
    ...
    >
      ...
      {!journeyShown ? (
        <Button
          variant={"secondary"}
          size="lg"
          className="mobile:text-sm text-md"
          onClick={() => setJourneyShown(true)}
        >
          <h1 className="mr-2">Explore my journey</h1>
          <ChevronDownIcon />
        </Button>
      ) : (
        <>
          ...
          <Button
            variant={"secondary"}
            size="lg"
            className="mobile:text-sm text-md mt-4"
            onClick={() => setJourneyShown(false)}
          >
            <h1 className="mr-2">Collapse journey</h1>
            <ChevronUpIcon />
          </Button>
        </>
      )}
